...
Requires a wireless card capable of injection

Installation
----
    sudo apt-get install python-scapy
    git clone https://github.com/wereallfeds/wifijammer
...
```shell
./wifijammer.py [-a AP MAC] [-c CHANNEL] [-d] [-i INTERFACE] [-m MAXIMUM] [-n] [-p PACKETS] [-s SKIP] [-t TIME INTERVAL]
```
